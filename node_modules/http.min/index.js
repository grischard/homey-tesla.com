    ...
    var promise = new Promise(function (resolve, reject) {
      ...
      var req = module.request(options, function (response) {
        ...
        response.on('data', function (chunk) {
          // console.log(chunk.trim()) >> debug code for realtime
          if (options.realtime && typeof options.realtime === 'function') options.realtime(chunk.trim())
          data += chunk
        })
...
function parseJSON (promise) {
  return promise.then(function (result) {
    try {
      ...
      return Promise.reject({error: e, result: result.data})
    }
  })
}
